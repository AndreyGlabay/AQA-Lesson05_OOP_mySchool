...
public class MainTests {    // (step 0.c) This line auto-created, when implemented MainTests java-class;
    // (step 1) Implement example of test-methods;
    public void login() {System.out.println("MainTests::login @ " + Thread.currentThread().getName());}
    public void signup() {System.out.println("MainTests::signup @ " + Thread.currentThread().getName());}
}
